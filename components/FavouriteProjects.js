    ...
    <div className="bg-[#F1F1F1] -mt-40 dark:bg-gray-900">
      <div className="max-w-6xl mx-auto">
        <header className="flex flex-col md:flex-row justify-between items-center pt-40 mx-10 md:my-20 lg:my-0">
          ...
          <Link href="https://docs.google.com/spreadsheets/d/1hpFuCZg6jsi8-ILpSVsXcERzLAEr_SfD/edit?usp=sharing&ouid=106687724990286850503&rtpof=true&sd=true">
            <a className="mb-20 md:mb-0 px-8 py-4 rounded-md bg-white shadow-lg text-xl font-semibold flex flex-row space-x-4 items-center dark:text-gray-700">
              ...
              <p><a href="https://docs.google.com/spreadsheets/d/1hpFuCZg6jsi8-ILpSVsXcERzLAEr_SfD/edit?usp=sharing&ouid=106687724990286850503&rtpof=true&sd=true">
                    <p>Grilles de compétences</p></a></p>
            </a>
          </Link>
        </header>
